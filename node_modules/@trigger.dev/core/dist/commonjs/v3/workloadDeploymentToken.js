...
exports.WorkloadDeploymentTokenClaims = zod_1.z.object({
    ver: zod_1.z.literal(exports.WORKLOAD_DEPLOYMENT_TOKEN_VERSION),
    /** Deployment friendlyId (deployment_xxxx). */
    deployment: zod_1.z.string(),
    deployment_version: zod_1.z.string(),
    environment_id: zod_1.z.string(),
    environment_type: zod_1.z.string(),
