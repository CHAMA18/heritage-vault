...
import { classifyDeploymentIdHeader, looksLikeWorkloadDeploymentToken, mintWorkloadDeploymentToken, verifyWorkloadDeploymentToken, WORKLOAD_DEPLOYMENT_TOKEN_VERSION, } from "./workloadDeploymentToken.js";
...
describe("workloadDeploymentToken", () => {
    ...
    it("mints byte-identical tokens for identical claims (deterministic, no iat)", async () => {
        ...
        if (!result.ok)
            return;
        expect(result.claims.iat).toBeUndefined();
    });
...
//# sourceMappingURL=workloadDeploymentToken.test.js.map