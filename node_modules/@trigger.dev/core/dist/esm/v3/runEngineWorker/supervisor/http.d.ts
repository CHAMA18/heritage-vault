...
export declare class SupervisorHttpClient {
    ...
    startRunAttempt(runId: string, snapshotId: string, body: WorkerApiRunAttemptStartRequestBody, runnerId?: string, environmentId?: string): Promise<import("../../zodfetch.js").ApiResult<{
        run: {
    ...
    completeRunAttempt(runId: string, snapshotId: string, body: WorkerApiRunAttemptCompleteRequestBody, runnerId?: string, environmentId?: string): Promise<import("../../zodfetch.js").ApiResult<{
        result: {
    ...
    getLatestSnapshot(runId: string, runnerId?: string, environmentId?: string): Promise<import("../../zodfetch.js").ApiResult<{
        execution: {
            run: {
                status: import("../../index.js").TaskRunStatus;
                id: string;
    ...
    getSnapshotsSince(runId: string, snapshotId: string, runnerId?: string, environmentId?: string): Promise<import("../../zodfetch.js").ApiResult<{
        snapshots: {
            run: {
                status: import("../../index.js").TaskRunStatus;
                id: string;
    ...
    continueRunExecution(runId: string, snapshotId: string, runnerId?: string, environmentId?: string): Promise<import("../../zodfetch.js").ApiResult<{
        run: {
            status: import("../../index.js").TaskRunStatus;
            id: string;
            friendlyId: string;
